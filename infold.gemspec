...
Gem::Specification.new do |spec|
  ...
  spec.summary     = "Scaffolding code generator for internal tools with Rails7 and Hotwire"
  spec.description = "Infold provides Scaffolding functionality specifically for Internal tools. Enables fast build, elegant UI/UX, flexible customization."
  spec.license     = "MIT"
  ...
  spec.metadata["source_code_uri"] = "https://github.com/yamataka22/infold"
  spec.metadata["changelog_uri"] = "https://github.com/yamataka22/infold/CHANGELOG.md"
